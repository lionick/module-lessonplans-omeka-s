...
namespace DoctrineProxies\__CG__\LessonPlans\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class LessonPlanSettings extends \LessonPlans\Entity\LessonPlanSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LessonPlanSettings $proxy) {
    ...
    public function setItemSet($item_set)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setItemSet', [$item_set]);

        return parent::setItemSet($item_set);
    }
